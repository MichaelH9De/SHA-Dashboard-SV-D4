    ...
    <div className="space-y-6">
      <Card>
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-4">
          <div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs uppercase tracking-[0.2em] text-slate-500">Organisation</div><div className="mt-2 font-semibold text-slate-900">{framework.organisation}</div></div>
          ...
          <div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs uppercase tracking-[0.2em] text-slate-500">Metrics</div><div className="mt-2 font-semibold text-slate-900">{framework.metricIds.length}</div></div>
        </div>
      </Card>
      <FrameworkMeasuresTable measureIds={framework.metricIds} />
    </div>
  )
}
